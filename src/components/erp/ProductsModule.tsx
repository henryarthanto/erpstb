...
export default function ProductsModule() {
  ...
  // Debounce search: only update filter after 300ms of no typing
      ...
      <Tabs defaultValue="products" className="w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-3 min-w-0 overflow-hidden">
          ...
          <div className="flex-1 flex gap-2 min-w-0">
            ...
            <span className="text-xs text-muted-foreground whitespace-nowrap shrink-0 self-center">
        ...
        <TabsContent value="products">
          ...
          {hasMore && (
            ...
            >
              Tampilkan Lebih Banyak ({products.length - displayCount} tersisa)
            </Button>
          )}
        </TabsContent>
