...
export function ExpenseDialog({ bankAccounts, cashBoxes, fundBalances, onClose, onSuccess }: ExpenseDialogProps) {
  ...
  const [fundSource, setFundSource] = useState<FundSource>('hpp_paid');
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select value={fundSource} onValueChange={(v) => { setFundSource(v as FundSource); setDestinationType('bank'); setDestinationId(''); }}>
